<?=$this -> load -> view('header'); ?>
        <div class="grid_24">
            <div class="page_title"><?=lang('settings_page_name'); ?></div>
        </div>
        ...
        <div class="grid_24"  id="sign_in_page">
            ...
            <div class="grid_6 omega">
                ...
                <select id="settings_language" name="settings_language" class="select select_ltr">
                    <option value=""><?php echo lang('settings_select'); ?></option>
            ...
            <div class="grid_6 omega">
                ...
                <select id="settings_timezone" name="settings_timezone" class="select select_ltr">
                    <option value=""><?php echo lang('settings_select'); ?></option>
